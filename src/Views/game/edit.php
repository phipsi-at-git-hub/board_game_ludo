    ...
    <fieldset>
        ...
        <label>
            ...
            <select name="<?php echo Application::LEAVE_HOME_ATTEMPT; ?>">
                ...
                <option value="<?= Application::ENUM_ALL_FIGURES ?>" <?= ($game->getRuleSetModel()->getLeaveHomeAttemptVariant() === Application::ENUM_ALL_FIGURES) ? 'selected' : '' ?> ><?= Localization::get('game.rules.leave_home_attempt_enum_all_figures') ?></option>
            </select>
        </label>
        <br><br>
        <label>
        ...
        <label>
            ...
            <select name="<?= Application::EXTRA_ROLL_ON_SIX_LIMIT; ?>">
                <option value="0" <?= ($game->getRuleSetModel()->getExtraRollOnSixLimit() === 0) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
                <option value="3" <?= ($game->getRuleSetModel()->getExtraRollOnSixLimit() > 0 && $game->getRuleSetModel()->getAllowStackOwnFigures() < 255) ? 'selected' : '' ?> ><?= Localization::get('game.create.three') ?></option>
                <option value="255" <?= ($game->getRuleSetModel()->getExtraRollOnSixLimit() === 255) ? 'selected' : '' ?> ><?= Localization::get('application.general.yes') ?></option>
            </select>
        </label>
        <br><br>
        <label>
