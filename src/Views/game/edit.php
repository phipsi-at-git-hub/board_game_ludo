        ...
        <fieldset>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::IS_PRIVATE; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->isPrivate()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
                    <option value="1" data-state="active" <?= ($game->isPrivate()) ? 'selected' : '' ?> ><?= Localization::get('application.general.yes') ?></option>
                </select>
            </div>
            <br>
            <div class="form-row">
                ...
                <select name="<?= Application::IS_LOCKED; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->isLocked()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
                    <option value="1" data-state="active" <?= ($game->isLocked()) ? 'selected' : '' ?> ><?= Localization::get('application.general.yes') ?></option>
                </select>
            </div>
        </fieldset>
        ...
        <fieldset>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::ALLOW_BOTS; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getAllowBots()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::ALL_FIGURES_START_AT_HOME; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getAllFiguresStartAtHome()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::START_FIELD_MUST_BE_CLEARED; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getStartFieldMustBeCleared()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?php echo Application::LEAVE_HOME_ATTEMPT; ?>" data-ui="switch" class="enhanced">
                    <option value="<?= Application::ENUM_FIRST_FIGURE ?>" data-state="inactive" <?= ($game->getRuleSetModel()->getLeaveHomeAttemptVariant() === Application::ENUM_FIRST_FIGURE) ? 'selected' : '' ?> ><?= Localization::get('game.rules.leave_home_attempt_enum_first_figure') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?php echo Application::LEAVE_HOME_ATTEMPTS_MAX; ?>" data-ui="switch" class="enhanced">
                    <option value="1" data-state="inactive" <?= ($game->getRuleSetModel()->getLeaveHomeAttemptsMax() === 1) ? 'selected' : '' ?> >1</option>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::EXTRA_ROLL_ON_SIX_LIMIT; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= ($game->getRuleSetModel()->getExtraRollOnSixLimit() === 0) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?php echo Application::FORCE_LEAVING_HOME_ON_SIX; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getForceLeavingHomeOnSix()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?php echo Application::FORCE_CAPTURE_ENEMY_FIGURES; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getForceCaptureEnemyFigures()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?php echo Application::FORCE_EXTRA_LAP_ON_OVERFLOW; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getForceExtraLapOnOverflow()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::ALLOW_STACK_OWN_FIGURES; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getAllowStackOwnFigures()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
            ...
            <div class="form-row">
                ...
                <select name="<?= Application::STRICT_GOAL_ORDER; ?>" data-ui="switch" class="enhanced">
                    <option value="0" data-state="inactive" <?= (!$game->getRuleSetModel()->getStrictGoalOrder()) ? 'selected' : '' ?> ><?= Localization::get('application.general.no') ?></option>
